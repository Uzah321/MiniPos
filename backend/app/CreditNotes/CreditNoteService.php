...
use App\Shifts\CashMovement;
use App\CreditNotes\CreditNote;
use App\CreditNotes\CreditNoteLine;
 ...
 * same provider abstraction as payments) or store credit Ã¢â‚¬â€ the last of
...
class CreditNoteService
{
     ...
     * credit Ã¢â‚¬â€ a lower-trust path since the original tender is unknown.
     *
