 ...
 * the provider approved but that second step is no longer valid — the
 * remaining balance changed underneath it, or a fault is simulated for
 * testing — the authorisation is reversed with the provider rather than
...
class SaleCheckoutService
{
     ...
     * (Pending or Unknown) — a captured/declined attempt is already final.
     ...
     * makes an exchange work — refund the returned item to store credit,
     ...
     * remaining balance — if it no longer does, or a commit failure is
